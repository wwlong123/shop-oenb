...
public class OSSClientUtil {
	...
	// accessKey
	private String accessKeyId = "LTAIAfC1CDM38YgK";
	private String accessKeySecret = "emQIzO5FsM2BIZH7LtPnTcx8qWpi67";
	// 空间
	private String bucketName = "wwlong";
	// 文件存储目录
	private String filedir = "Along";
